...
<head>
  ...
  <title>Vendor | Dashboard 2</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Vendor 3</span>
    </a>
      ...
      <nav class="mt-2">
         <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a href="/viewvendorproduct" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                view product
           ...
           <li class="nav-item">
            <a href="/vendorlogout" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
               Logout
